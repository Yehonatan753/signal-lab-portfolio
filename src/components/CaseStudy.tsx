...
export default function CaseStudy() {
  const cs = SITE_DATA.caseStudies.tomer;

  return (
    <section id="case-study-tomer" className="relative py-24 md:py-32 px-6 md:px-16 lg:px-24 bg-surface/20">
      ...
      <div className="max-w-6xl mx-auto relative z-10">
        ...
        >
          ...
          <h2 className="text-5xl md:text-6xl font-heading font-black text-white leading-[1.1] tracking-tighter mb-4">
            From card to <span className="text-glow-animate">sales machine.</span>
          </h2>
            ...
            <div className="grid grid-cols-2 gap-4">
              {cs.metrics.map((m, i) => (
                <div key={i} className="glass-panel rounded-2xl p-6 text-center border border-white/5">
                  <div className={`text-4xl font-heading font-black leading-none mb-1 ${metricColors[i]}`}>
                    {m.num}
                  </div>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 mb-6">
          {cs.built.map((item, i) => {
            ...
            return (
              ...
              >
                <div className={`size-10 rounded-xl ${c.bg} flex items-center justify-center mb-4`}>
