    ...
    <section id="testimonials" className="relative py-24 md:py-32 px-6 md:px-16 lg:px-24 bg-bg">
      ...
      <div className="max-w-6xl mx-auto relative z-10">
        ...
        <motion.div
          ...
          className="mb-14"
        >
          <p className="text-xs font-bold tracking-[3px] uppercase text-signal mb-4">Testimonials & Proof Notes</p>
          <h2 className="text-5xl md:text-6xl font-heading font-black text-white leading-[1.1] tracking-tighter">
            Proof from each<br />
            <span className="text-glow-animate">lane.</span>
          </h2>
        </motion.div>
          ...
          {SITE_DATA.testimonials.map((t, i) => (
            ...
            >
              ...
              {t.kind === 'testimonial' ? (
                ...
                <div className="mb-5">
                  <span className="inline-flex text-[10px] font-bold tracking-[2px] uppercase text-signal bg-signal/10 border border-signal/20 px-2.5 py-1 rounded-full">
                    Proof note
                  </span>
                </div>
              )}
